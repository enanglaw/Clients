  ...
  function getTargetDOMElement(binding, view) {
      ...
      for (let i = 0, ii = view.controllers.length; i < ii; i++) {
          ...
          if (controller.viewModel === target) {
              const element = controller.container.get(aureliaPal.DOM.Element);
              if (element) {
                  return element;
              }
  ...
  ***************************************************************************** */
  ...
  class ValidateBindingBehaviorBase {
      ...
      bind(binding, source, rulesOrController, rules) {
          ...
          const event = (trigger & exports.validateTrigger.blur) === exports.validateTrigger.blur ? 'blur'
              : (trigger & exports.validateTrigger.focusout) === exports.validateTrigger.focusout ? 'focusout'
                  : null;
          const hasChangeTrigger = (trigger & exports.validateTrigger.change) === exports.validateTrigger.change;
   ...
   */
  exports.ValidateBindingBehavior = class ValidateBindingBehavior extends ValidateBindingBehaviorBase {
      getValidateTrigger(controller) {
          return controller.validateTrigger;
      }
  };
  exports.ValidateBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
   ...
   */
  exports.ValidateManuallyBindingBehavior = class ValidateManuallyBindingBehavior extends ValidateBindingBehaviorBase {
      getValidateTrigger() {
          return exports.validateTrigger.manual;
      }
  };
  exports.ValidateManuallyBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
  exports.ValidateManuallyBindingBehavior = __decorate([
      aureliaBinding.bindingBehavior('validateManually')
  ], exports.ValidateManuallyBindingBehavior);
  /**
   * Binding behavior. Indicates the bound property should be validated
   * when the associated element blurs.
   */
  exports.ValidateOnBlurBindingBehavior = class ValidateOnBlurBindingBehavior extends ValidateBindingBehaviorBase {
      getValidateTrigger() {
          return exports.validateTrigger.blur;
      }
  };
  exports.ValidateOnBlurBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
  exports.ValidateOnBlurBindingBehavior = __decorate([
      aureliaBinding.bindingBehavior('validateOnBlur')
  ], exports.ValidateOnBlurBindingBehavior);
  /**
   * Binding behavior. Indicates the bound property should be validated
   * when the associated element is changed by the user, causing a change
   * to the model.
   */
  exports.ValidateOnChangeBindingBehavior = class ValidateOnChangeBindingBehavior extends ValidateBindingBehaviorBase {
      getValidateTrigger() {
          return exports.validateTrigger.change;
      }
  };
  exports.ValidateOnChangeBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
  exports.ValidateOnChangeBindingBehavior = __decorate([
      aureliaBinding.bindingBehavior('validateOnChange')
  ], exports.ValidateOnChangeBindingBehavior);
  /**
   * Binding behavior. Indicates the bound property should be validated
   * when the associated element blurs or is changed by the user, causing
   * a change to the model.
   */
  exports.ValidateOnChangeOrBlurBindingBehavior = class ValidateOnChangeOrBlurBindingBehavior extends ValidateBindingBehaviorBase {
      getValidateTrigger() {
          return exports.validateTrigger.changeOrBlur;
      }
  };
  exports.ValidateOnChangeOrBlurBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
  exports.ValidateOnChangeOrBlurBindingBehavior = __decorate([
      aureliaBinding.bindingBehavior('validateOnChangeOrBlur')
  ], exports.ValidateOnChangeOrBlurBindingBehavior);
  exports.ValidateOnFocusoutBindingBehavior = class ValidateOnFocusoutBindingBehavior extends ValidateBindingBehaviorBase {
      getValidateTrigger() {
          return exports.validateTrigger.focusout;
      }
  };
  exports.ValidateOnFocusoutBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
  exports.ValidateOnFocusoutBindingBehavior = __decorate([
  ...
  exports.ValidateOnChangeOrFocusoutBindingBehavior.inject = [aureliaTaskQueue.TaskQueue];
  exports.ValidateOnChangeOrFocusoutBindingBehavior = __decorate([
      aureliaBinding.bindingBehavior('validateOnChangeOrFocusout')
  ], exports.ValidateOnChangeOrFocusoutBindingBehavior);
  ...
  exports.ValidationRendererCustomAttribute = class ValidationRendererCustomAttribute {
      created(view) {
